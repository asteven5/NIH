                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          '${getJsonField(
                            widget.barcode,
                            r'''$.gudid.device.companyName''',
                          ).toString()} | ${getJsonField(
                            widget.barcode,
                            r'''$.gudid.device.identifiers.identifier.deviceId''',
                          ).toString()}',
                          style:
                      ...
                      children: [
                        Expanded(
                          child: Text(
                            getJsonField(
                              widget.barcode,
                              r'''$.gudid.device.deviceDescription''',
                            ).toString(),
                            style: FlutterFlowTheme.of(context)
                                .labelMedium
                                .override(
                            ...
                            children: [
                              Padding(
                                ...
                                child: Text(
                                  getJsonField(
                                    widget.barcode,
                                    r'''$.gudid.device.identifiers.identifier.pkgQuantity''',
                                  ).toString(),
                                  style: FlutterFlowTheme.of(context)
                                      .labelMedium
                                      .override(
